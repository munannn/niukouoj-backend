...
public class JavaLanguageJudgeStrategy implements JudgeStrategy {
    ...
    public JudgeInfo doJudge(JudgeContext judgeContext) {
        ...
        List<String> inputList = judgeContext.getInputCaseList();
        List<String> outputList = judgeContext.getOutputCaseList();
        ...
        // 假设Java 程序本身需要额外执行300ms
        final long JAVA_PROGRAM_TIME_COST = 300L;
